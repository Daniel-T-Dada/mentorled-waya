                ...
                <div className="flex items-center justify-between h-16 py-4">
                    ...
                    <div className="hidden md:flex space-x-4">
                        <Link href="/login" onClick={(e) => e.preventDefault()}>
                            <Button variant="solid" className="bg-[#500061] hover:bg-[#9514b7] text-white hover:text-secondary font-semibold mr-4">
                                Sign Up
                            </Button>
                        </Link>
                    ...
                    <div className="md:hidden absolute top-16 left-0 right-0 bg-white border-b shadow-lg">
                        <nav className="flex flex-col px-4 py-2">
                            ...
                            <div className="flex flex-col gap-2 py-4">
                                <Link href="/login" onClick={(e) => e.preventDefault()}>
                                    <Button variant="solid" className="w-full bg-[#500061] hover:bg-[#9514b7] text-white hover:text-secondary font-semibold">
                                        Sign Up
                                    </Button>
                                </Link>
                                <Link href="/register" onClick={(e) => e.preventDefault()}>
